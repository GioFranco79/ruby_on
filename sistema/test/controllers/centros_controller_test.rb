...
class CentrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post centros_url, params: { centro: { ciudad: @centro.ciudad, comuna: @centro.comuna, direccion: @centro.direccion, fono: @centro.fono, nombre: @centro.nombre, rut: @centro.rut } }
    end
  ...
  test "should update centro" do
    patch centro_url(@centro), params: { centro: { ciudad: @centro.ciudad, comuna: @centro.comuna, direccion: @centro.direccion, fono: @centro.fono, nombre: @centro.nombre, rut: @centro.rut } }
