...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { box: @agenda.box, fagenda: @agenda.fagenda, horario_id: @agenda.horario_id, paciente_id: @agenda.paciente_id, profesional_id: @agenda.profesional_id } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { box: @agenda.box, fagenda: @agenda.fagenda, horario_id: @agenda.horario_id, paciente_id: @agenda.paciente_id, profesional_id: @agenda.profesional_id } }
