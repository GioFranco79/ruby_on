...
class DojosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dojo" do
    assert_difference('Dojo.count') do
      post dojos_url, params: { dojo: { city: @dojo.city, nombre: @dojo.nombre, state: @dojo.state } }
    end
  ...
  test "should update dojo" do
    patch dojo_url(@dojo), params: { dojo: { city: @dojo.city, nombre: @dojo.nombre, state: @dojo.state } }
