...
class ProfesionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesional" do
    assert_difference('Profesional.count') do
      post profesionals_url, params: { profesional: { apellido: @profesional.apellido, email: @profesional.email, especialidad: @profesional.especialidad, fnac: @profesional.fnac, fono: @profesional.fono, nombre: @profesional.nombre, rut: @profesional.rut, titulo: @profesional.titulo } }
    end
  ...
  test "should update profesional" do
    patch profesional_url(@profesional), params: { profesional: { apellido: @profesional.apellido, email: @profesional.email, especialidad: @profesional.especialidad, fnac: @profesional.fnac, fono: @profesional.fono, nombre: @profesional.nombre, rut: @profesional.rut, titulo: @profesional.titulo } }
