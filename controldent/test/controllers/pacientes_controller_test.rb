...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { apellido: @paciente.apellido, email: @paciente.email, fechanac: @paciente.fechanac, fono: @paciente.fono, nombre: @paciente.nombre, prevision: @paciente.prevision, rut: @paciente.rut } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { apellido: @paciente.apellido, email: @paciente.email, fechanac: @paciente.fechanac, fono: @paciente.fono, nombre: @paciente.nombre, prevision: @paciente.prevision, rut: @paciente.rut } }
