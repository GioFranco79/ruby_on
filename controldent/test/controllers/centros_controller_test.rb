...
class CentrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post centros_url, params: { centro: { ciudad: @centro.ciudad, cliente_id: @centro.cliente_id, comuna: @centro.comuna, direccion: @centro.direccion, email: @centro.email, fono: @centro.fono, nombre: @centro.nombre } }
    end
  ...
  test "should update centro" do
    patch centro_url(@centro), params: { centro: { ciudad: @centro.ciudad, cliente_id: @centro.cliente_id, comuna: @centro.comuna, direccion: @centro.direccion, email: @centro.email, fono: @centro.fono, nombre: @centro.nombre } }
