...
class EspecialidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialidad" do
    assert_difference('Especialidad.count') do
      post especialidads_url, params: { especialidad: { centro_id: @especialidad.centro_id, nomesp: @especialidad.nomesp, profesional_id: @especialidad.profesional_id } }
    end
  ...
  test "should update especialidad" do
    patch especialidad_url(@especialidad), params: { especialidad: { centro_id: @especialidad.centro_id, nomesp: @especialidad.nomesp, profesional_id: @especialidad.profesional_id } }
